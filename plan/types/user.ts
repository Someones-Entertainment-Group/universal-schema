...
export type VenueProviderExtra = {
    date_of_birth: string
    gender: string
    venue_type: string
    max_visitors: string
...
export type EventOwnerUser = User & {
    event_owner_extra: {
        date_of_birth: string
        gender: string
    }
...
export type VenderUser = User & {
    vender_extra: VenderExtra
}

export type InfluencerUser = User & {
    influencer_extra: InfluencerExtra
}

export type VenueProviderUser = User & {
    venue_provider_extra: VenueProviderExtra
}

export type PlannerProUser = User & {
    planner_pro_extra: PlannerProExtra
}

export type PartySeekerUser = User & {
